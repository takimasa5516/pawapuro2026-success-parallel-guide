...
export const catcherFlow: FlowStep[] = [
  ...
  },
  {
    ...
    spaceTimeLv: "4",
    recruitMember: "早川 あおい（同行加入）",
    notes: "あおいを同行枠に追加（ハルキとの送球Lv3コンボ布石）。※六道聖は神楽坂グループで加入します（継承選手に設定時は時空Lv5で加入可能）。",
    targetCombo: "あおい ＋ ハルキ",
  ...
  },
  {
    ...
    spaceTimeLv: "5",
    recruitMember: "美藤 千尋（加入）",
    notes: "基礎能力コツを2回確実に取得。美藤千尋加入。時空Lv5到達で継承選手が加入！（継承に六道聖を設定している場合はここで進＋聖コンボ解放！）",
    targetCombo: "あおい ＋ 友沢",
...
export const strategyTips: StrategyTip[] = [
  ...
  {
    title: "六道聖の加入仕様と【進＋聖】フレーミング◯の解放",
    timing: "中盤〜（神楽坂グループ修復 or 時空Lv5継承）",
    tag: "捕手育成・最重要仕様",
    description:
      "六道聖のシナリオ出現時空は「神楽坂グループ」です。キャットハンズ（早川あおい/橘みずき）等では加入しません。猪狩進とのコンボ【進＋聖】で最強捕手特能「フレーミング◯」や「広角打法」を早期に狙う場合は、継承選手枠に六道聖を設定しておくことで時空Lv5達成時に即時加入させることができます。",
    details: [
      "六道聖の正規加入時空: 神楽坂グループ（修復完了時に加入）",
      "キャットハンズで加入するのは『早川あおい / 橘みずき』のみ（聖は加入しません）",
      "早期解放テクニック: あらかじめ六道聖の継承選手を設定しておけば、時空Lv5（目安11〜15ターン目・聖ジャスミンクリア時）で聖が即時加入し、あかつきの進と即座にコンボ可能！",
