...
export const pitcherFlow: FlowStep[] = [
  {
    ...
    notes: "最序盤。四条澄香の練習を追って好感度上げ＆猪狩進を同行枠に確保。",
    highlight: true,
  },
  {
    no: 2,
    ...
    notes: "No2, 3, 4は状況に応じて入替可能。パワフル高校で松倉が加入。",
    highlight: true,
  },
  {
    no: 3,
  ...
  },
  {
    ...
    notes: "キャットハンズで早川あおいを同行枠に確保（ハルキや友沢とのコンボ布石）。",
    highlight: true,
  },
  {
    no: 5,
    ...
    notes: "基礎能力コツを最優先で回収。聖ジャスミン学園で美藤千尋が加入。時空Lv5達成で継承選手が加入！",
    highlight: true,
  },
  {
    no: 6,
  ...
  },
  {
    ...
    targetCombo: "あおい ＋ 友沢",
    comboChoice: "【弁償する】内角攻めLv3 / ジャイロボールLv3",
    highlight: true,
  },
  {
    no: 10,
    ...
    notes: "神楽坂グループで六道聖が加入！あかつきで連れてきた猪狩進と揃い【進＋聖】低め◯Lv3コンボ解放！日和ミヨの出現時空でもあります。",
    targetCombo: "進 ＋ 聖",
  ...
  },
  {
    ...
    notes: "神宮寺光を同行枠に確保（アオハルでの球速Lv3コンボ布石）。※神宮寺を選んだため小山雅は仲間になりません。",
  },
  {
    no: 12,
    destination: "仏契",
  ...
  },
  {
    ...
    notes: "セティーヌ加入！天空中央の虹谷誠と揃い【虹谷＋セティ】ノビLv3コンボ解放！大量経験点を回収。",
    targetCombo: "虹谷 ＋ セティ",
...
export const catcherFlow: FlowStep[] = [
  ...
  },
  {
    ...
    spaceTimeLv: "2",
    recruitMember: "松倉 宗光（加入）",
    notes: "ラブパワー中に四条と練習でパワドリンク回収。松倉宗光が加入。",
    highlight: true,
  },
  {
    no: 3,
    ...
    spaceTimeLv: "4",
    recruitMember: "早川 あおい（同行加入）",
    notes: "早川あおいを同行枠に追加（フューチャーズのハルキとの送球Lv3コンボ布石）。",
    highlight: true,
  },
  {
    no: 4,
  ...
  },
  {
    ...
    spaceTimeLv: "5",
    recruitMember: "美藤 千尋（加入）",
    notes: "基礎能力コツを2回確実に取得。美藤千尋が加入。時空Lv5到達で継承選手が加入！",
    highlight: true,
  },
  {
    no: 6,
  ...
  },
  {
    ...
    spaceTimeLv: "8",
    recruitMember: "神宮寺 光（同行加入）",
    notes: "神宮寺光を同行枠へ（アオハルでのミートLv3コンボ布石）。※神宮寺を選んだため小山雅は仲間になりません。",
    highlight: true,
  },
  {
    no: 8,
  ...
  },
  {
    ...
    spaceTimeLv: "10",
    recruitMember: "黒珠 真（加入）",
    notes: "黒珠真が加入！パワフルの松倉宗光と揃い【黒珠＋松倉】ダメ押しLv3コンボ解放。デートイベント経験点も増加。",
    targetCombo: "黒珠 ＋ 松倉",
  ...
  },
  {
    ...
    spaceTimeLv: "10",
    recruitMember: "セティーヌ（加入）",
    notes: "セティーヌ加入！天空中央の虹谷誠と揃い【虹谷＋セティ】ムード◯Lv3コンボ解放！大量経験点を回収。",
    targetCombo: "虹谷 ＋ セティ",
  ...
  },
  {
    ...
    spaceTimeLv: "10",
    recruitMember: "ハルキ（加入）",
    notes: "ハルキ加入！同行枠の早川あおいと揃い【ハルキ＋あおい】送球Lv3コンボ解放！",
    targetCombo: "あおい ＋ ハルキ",
...
export const fielderFlow: FlowStep[] = [
  {
    ...
    notes: "四条澄香を彼女にし、猪狩守を同行枠に確保（守備力Lv3コンボ布石）。",
    highlight: true,
  },
  {
    no: 2,
  ...
  },
  {
    ...
    notes: "橘みずきを同行枠に追加！あかつきの猪狩守と揃い【守＋みずき】守備力Lv3コンボ解放！",
    targetCombo: "猪狩守 ＋ みずき",
  ...
  },
  {
    ...
    spaceTimeLv: "5",
    recruitMember: "美藤 千尋（加入）",
    notes: "基礎能力コツを2回回収。聖ジャスミンで美藤千尋が加入。時空Lv5で継承選手加入！",
    highlight: true,
  },
  {
    no: 6,
  ...
  },
  {
    ...
    spaceTimeLv: "8",
    recruitMember: "神宮寺 光（同行加入）",
    notes: "優先度大！神宮寺光を同行枠へ（アオハルでのミートLv3コンボ布石）。※神宮寺を選んだため小山雅は仲間になりません。",
    highlight: true,
  },
  {
    no: 8,
...
export const strategyTips: StrategyTip[] = [
  ...
  },
  {
    ...
    tag: "捕手育成・重要仕様",
    description:
      "六道聖が加入する時空は「神楽坂グループ」です。あかつき大附属で猪狩進を同行加入させ、神楽坂グループで六道聖を仲間にすることで、捕手最重要特能「フレーミング◯」や「広角打法」を獲得できる【進＋聖】コンボが解放されます。",
    details: [
      "六道聖の加入時空: 神楽坂グループ（修復完了時に正式加入）",
      "コンボ解放条件: 猪狩進（あかつき）と六道聖（神楽坂グループ）の両方が仲間にいる状態でランダム発生",
      "コンボ選択肢: 【ふたり同時に練習！】で広角打法Lv3 / フレーミング◯Lv3（野手・捕手）、低め◯Lv3 / 対ランナー◯Lv3（投手）",
      "【日替わりで練習！】ではバント◯Lv3 / サブポジ捕手Lv3（野手）、重い球Lv3 / 安全圏◯Lv3（投手）を獲得",
    ],
    icon: "Users",
  },
];
