...
export const heroinesData: HeroineInfo[] = [
  {
    ...
    recommendPositions: ["投手 (精密機械/鉄腕)", "外野手/野手 (高速レーザー/左腕キラー)"],
    tips: "初期時空（あかつき）ですぐに彼女にできるため、育成序盤の安定感は抜群。デート4回目で【振り返ったら呪われる】を選ぶと投手は『精密機械Lv2』、野手は『高速レーザーLv2』を取得。デート完走（5回目）で投手は『クロスファイヤーLv1』、野手は『アベレージヒッターLv1』と全ステータス+40が確定入手できます。また汎用デート（まったり、満腹、哲学、買い物、ワクワク）でも好感度+24と経験点が獲得可能。",
